...
# [3,]    3    7   11   15
# [4,]    4    8   12   16
rowSums(A)      #-- [1] 28 32 36 40 --- 有rowSums
apply(A,1,max)  #-- [1] 13 14 15 16 --- 但沒有rowMax---也可有如下另兩種寫法
sapply(1:dim(A)[1],  FUN=function(i)max(A[i,]) )  #-- [1] 13 14 15 16
maxA = NULL;  for (i in 1:dim(A)[1]) { maxA[i] = max(A[i,]) };  maxA  #-- [1] 13 14 15 16
