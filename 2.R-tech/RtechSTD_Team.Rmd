---
title: "Google playstore 數據分析初步報告"
author: "Eugina"
date: "報告時間：2020/12/04"
output: 
...
## (2.1) (KDD2) 商品探索 (X) -->
```{r echo=FALSE, warning=FALSE}
pander(paste0(">> (1) app品項共有: ",length(unique(X$App)),"\n\n") )
pander(paste0(">> (2) app品類共有: ",length(unique(X$Category)),"\n\n") )
...
<!-- } -->
<!-- round(Gmean,2)[order(Gmean[,2],decreasing=T),] -->
<!-- ``` -->
<!-- # (3) (KDD3) 數據轉換 (X->Cv) -->
...
<!-- Cv$DD0 = cut( Cv$DD, breaks=c(0,1,9,99,999,9999,99999));  # table(Cv$DD0) -->
<!-- # (0,1]         (1,3]         (3,9]        (9,30]      (30,200] (200,1.2e+03] -->
<!-- # 26654          2118            53             0             0             0 -->
<!-- Cv$FF0 = cut( Cv$FF, breaks=c(0,1,9,99,999,9999,99999));  # table(Cv$FF0) -->
<!-- # (0,1]    (1,3]    (3,9]   (9,30]  (30,99] (99,999] -->
<!-- # 9718    13595     4811      692        9        0 -->
<!-- Cv$MM0 = cut( Cv$MM, breaks=c(-99999,0,9999,99999,999999,9999999,99999999,1999999999)); # table(Cv$MM0) -->
<!-- # (-1,0]       (0,999]   (999,1e+04] (1e+04,1e+05] (1e+05,1e+06] (1e+06,2e+06] -->
<!-- #   5101          9568         60563            31             0             0 -->
<!-- Cv$BB0 = cut( as.numeric(Cv$BB), breaks=c(-1,0,7,30,100,999));  # table(Cv$BB0) -->
<!-- # (-1,0]       (0,999]   (999,1e+04] (1e+04,1e+05] (1e+05,1e+06] (1e+06,2e+06] -->
<!-- #    600          1403         24362          2457             3             0 -->
