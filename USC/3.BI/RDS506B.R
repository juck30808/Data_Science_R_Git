# RDS506B.R: basic R program for Retail Data Analysis - 06
# Jia-Sheng Heh, 01/08/2021, revised from RDS506A.R

wkDir = "C:/Users/jsheh/Desktop/working/RDS5/";   setwd(wkDir)
...
dataset0 = XXXFM[,c("CvFF0","CvMM0","customer","category","price")]
...
DS = dataset
DS$price0 = cut(DS$price,breaks=c(-1,0,999,2999,9999))   #---  要加這一行才會對 ***
